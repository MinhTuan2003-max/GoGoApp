        ...
        holder.btnAddToPlan.setOnClickListener(v -> {
            ...
            new AlertDialog.Builder(holder.itemView.getContext())
                    ...
                    .setPositiveButton("Thêm", (dialog, which) -> {
                        ...
                        ExercisePlan existingPlan = planRepo.getPlanByExerciseIdAndPlanName(exercise.getExerciseID(), planName, userId);

                        if (existingPlan != null) {
                            int newDuration = existingPlan.getDuration() + duration;
                            int newCaloriesBurned = (int) (exercise.getEnergyConsumed() * newDuration);
